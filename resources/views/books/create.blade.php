	...
	<div class="col-md-10 col-md-offset-1">
		...
		<form method="POST" action="/books" enctype="multipart/form-data">
			...
			<div class="form-group col-md-6">
				...
				<div>
					<input type="checkbox" value="Fantasy"> <span class="badge">Fantasy</span>
					<input type="checkbox" value="Sci-Fi"> <span class="badge">Sci-Fi</span>
					<input type="checkbox" value="Comedy"> <span class="badge">Comedy</span>
					<input type="checkbox" value="Action"> <span class="badge">Action</span>
					<input type="checkbox" value="Drama"> <span class="badge">Drama</span>
					<input type="checkbox" value="MMO"> <span class="badge">MMO</span><br/>
					<input type="checkbox" value="Male-Protagonist"> <span class="badge">Male-Protagonist</span>
					<input type="checkbox" value="Female-Protagonist"> <span class="badge">Female-Protagonist</span><br/>
