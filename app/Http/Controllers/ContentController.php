...
//		$access_token = '811596832280396|RqbSrEt8yah1feLwm4OGKQo-5as';
	...
	public function show($id, $chapter)
	{
		...
		$book = Book::findOrFail($id);
		if($book->isComic())
			return view('contents.show',compact('content_chap', 'book'))->with('content_images',json_decode($content_chap->content));
		return view('contents.show',compact('content_chap', 'book'));
	}
